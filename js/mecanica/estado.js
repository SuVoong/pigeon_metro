...
export const CHARACTERS = [
  {
    ...
    drawPreview(ctx, cx, cy) {
      // Sprite 32×32 pixel 3D, escala 2× (personaje.js añade 1.5×). Frame 0, nivel.
      ctx.save();
      ctx.translate(cx, cy);
      ctx.scale(2, 2);
      const ox = -16, oy = -16;
      ...
      // Pico
      p(20,3,2,1,'#D4A855'); p(21,4,2,1,'#9A7830');
      // Cabeza base + highlights + sombras
      p(12,0,8,7,'#8899AA');
      p(14,0,4,1,'#C4D4E6'); p(13,1,3,1,'#C4D4E6'); p(12,2,2,1,'#C4D4E6');
      p(19,2,1,4,'#5A6B7C'); p(18,5,2,2,'#5A6B7C'); p(12,5,1,2,'#5A6B7C');
      // Ojo con pupila
      p(19,2,2,2,'#FFFFFF'); p(20,3,1,1,'#1A1A2A');
      // Collar iridiscente 2 tonos
      p(10,7,5,1,'#66CCEE'); p(15,7,5,1,'#DD77DD');
      p(10,8,5,1,'#1F5577'); p(15,8,5,1,'#772288');
      // Cuerpo 3D
      p(8,9,16,14,'#8899AA'); p(10,9,12,2,'#AABCCE');
      p(8,9,2,12,'#5A6B7C'); p(22,9,2,12,'#5A6B7C'); p(9,20,14,3,'#3C4D5E');
      // Vientre
      p(11,10,10,9,'#CCCCDD'); p(12,11,8,7,'#EEEEFF');
      // Alas frame 0 (wingY=11, tipY=14): highlight, base, tip, sombra borde, separadores
      p(0,10,8,1,'#8A9DAF'); p(0,11,8,3,'#556677'); p(0,14,8,2,'#1E3040'); p(0,14,8,1,'#38495A');
      p(2,11,1,3,'#38495A'); p(5,11,1,3,'#38495A');
      p(24,10,8,1,'#8A9DAF'); p(24,11,8,3,'#556677'); p(24,14,8,2,'#1E3040'); p(24,14,8,1,'#38495A');
      p(25,11,1,3,'#38495A'); p(28,11,1,3,'#38495A');
      // Cola con separadores
      p(13,22,6,1,'#667788'); p(11,23,10,2,'#445566');
      p(10,25,12,1,'#2E3F50'); p(9,26,14,1,'#2E3F50'); p(8,27,16,1,'#162636');
      p(14,23,1,5,'#1A2B3C'); p(18,23,1,5,'#1A2B3C');
      // Patas con sombra
      p(11,22,2,3,'#E8AA88'); p(12,22,1,3,'#B07855');
      p(19,22,2,3,'#E8AA88'); p(20,22,1,3,'#B07855');
      // Pies con dedo trasero y garra
      p(9,24,4,1,'#C08864'); p(19,24,4,1,'#C08864');
      p(8,24,2,1,'#8A5A3A'); p(22,24,2,1,'#8A5A3A');
      p(9,25,1,1,'#8A5A3A'); p(22,25,1,1,'#8A5A3A');
      ctx.restore();
    },
  },
  {
